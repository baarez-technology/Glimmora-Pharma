...
INSERT INTO "new_Finding" ("area", "createdAt", "createdBy", "evidenceLink", "framework", "id", "linkedCAPAId", "owner", "previousCAPAId", "reference", "requirement", "rootCause", "severity", "siteId", "status", "targetDate", "tenantId", "updatedAt") SELECT "area", "createdAt", "createdBy", "evidenceLink", "framework", "id", "linkedCAPAId", "owner", "previousCAPAId", "reference", "requirement", "rootCause", "severity", "siteId", "status", "targetDate", "tenantId", "updatedAt" FROM "Finding";
DROP TABLE "Finding";
ALTER TABLE "new_Finding" RENAME TO "Finding";
CREATE UNIQUE INDEX "Finding_reference_key" ON "Finding"("reference");
CREATE TABLE "new_RTMEntry" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
INSERT INTO "new_RTMEntry" ("createdAt", "dsReference", "dsStatus", "evidenceStatus", "fsReference", "fsStatus", "id", "iqResult", "iqTestId", "linkedFindingId", "notes", "oqResult", "oqTestId", "pqResult", "pqTestId", "systemId", "traceabilityStatus", "updatedAt", "ursId", "ursPriority", "ursRegulation", "ursRequirement") SELECT "createdAt", "dsReference", "dsStatus", "evidenceStatus", "fsReference", "fsStatus", "id", "iqResult", "iqTestId", "linkedFindingId", "notes", "oqResult", "oqTestId", "pqResult", "pqTestId", "systemId", "traceabilityStatus", "updatedAt", "ursId", "ursPriority", "ursRegulation", "ursRequirement" FROM "RTMEntry";
DROP TABLE "RTMEntry";
ALTER TABLE "new_RTMEntry" RENAME TO "RTMEntry";
