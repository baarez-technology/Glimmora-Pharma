...
export const AUDIT_EVENT_LABELS: Record<string, string> = {
  ...
  SYSTEM_SOFT_DELETED: "System deleted",
  SYSTEM_RESTORED: "System restored",
  SYSTEM_VALIDATION_SIGNED: "Validation sign-off signed",
  SYSTEM_VALIDATION_UNSIGNED: "Validation sign-off revoked",
  SYSTEM_STATUS_AUTO_DERIVED: "Validation status auto-derived",
  SYSTEM_STATUS_MANUALLY_ATTESTED: "Validation status manually attested",
  SYSTEM_RISK_CLASSIFICATION_UPDATED: "System risk classification updated",
  SYSTEM_CAPA_RAISED: "CAPA raised from system",
  SYSTEM_FINDING_LINKED: "Finding linked to system",
  SYSTEM_FINDING_UNLINKED: "Finding unlinked from system",
  STAGE_SUBMITTED_FOR_REVIEW: "Validation stage submitted for review",
  STAGE_APPROVED: "Validation stage approved",
  STAGE_REJECTED: "Validation stage rejected",
  STAGE_SKIPPED: "Validation stage skipped (not applicable)",
  STAGE_DOCUMENT_UPLOADED: "Validation document uploaded",
  STAGE_DOCUMENT_SOFT_DELETED: "Validation document removed",
  STAGE_NOTES_UPDATED: "Validation stage notes updated",
  STAGE_REWORK_TASK_ASSIGNED: "Validation rework task assigned",
  ...
  EVIDENCE_FILE_SOFT_DELETED: "Evidence removed",
  EVIDENCE_INITIALIZED: "Evidence categories initialised",
  EVIDENCE_STATUS_CHANGED: "Evidence status changed",
  EVIDENCE_NOTE_UPDATED: "Evidence notes updated",
  EVIDENCE_REJECTED: "Evidence rejected",
  EVIDENCE_APPROVED: "Evidence approved",
  DOCUMENT_APPROVAL_SIGNED: "Document approval signed",
