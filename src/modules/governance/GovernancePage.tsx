            ...
            {exportMenuOpen && (
              ...
              >
                {[
                  ...
                  { label: "Training & Awareness Pack", Icon: Shield, onClick: exportReadiness },
                ].map((opt) => (
                  <button
                    key={opt.label}
                    type="button"
